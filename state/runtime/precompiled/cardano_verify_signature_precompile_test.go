...
func createTx(t *testing.T) ([]byte, string) {
	...
	outputsSum := cardanowallet.GetOutputsSum(outputs)[cardanowallet.AdaTokenName]
	...
	multiSigInputs.Sum[cardanowallet.AdaTokenName] = cardanowallet.MinUTxODefaultValue*2 + 20
	...
	multiSigFeeInputs.Sum[cardanowallet.AdaTokenName] = cardanowallet.MinUTxODefaultValue * 2
	...
	builder.UpdateOutputAmount(-2, multiSigInputs.Sum[cardanowallet.AdaTokenName]-outputsSum)
